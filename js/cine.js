	...
	if( data.status ==200) {
		...
		<div class="cine-info">
			<div class="cine-info datos">
				...
				<div class="tabla">
					<div class="fila">
						<div class="celda-titulo">${cine1.DiasSemana}</div>
						<div class="celda">${cine1.Precio}</div>
					</div>
			...
			<div class="cine-info peliculas">
				<div class="tabla">
					...
					<div class="fila impar">
						<div class="celda-titulo">${cine2.Titulo}</div>
						<div class="celda">${cine2.Horarios}</div>
					</div>
					<div class="fila">
						<div class="celda-titulo">${cine2.Titulo}</div>
						<div class="celda">${cine2.Horarios}</div>
